...
const bio = {
  ...
  ar: [
    ...
    "في ثماني شركات — أحدثها انضمامي إلى Craft Crew في يونيو 2026 لشحن نظام إدارة تعلم — بنيت متاجر إلكترونية تعالج عشرة آلاف معاملة شهريًا، ولوحات تحكم مستشفيات يستخدمها 150 ممرضًا كل صباح، وواجهات أسواق تصل إلى خمسين ألف لاعب، وكل الأشياء اليومية بينها: نماذج لا تفقد حالتها، جداول تظل سريعة بعد ألف صف، أنظمة تصميم تُستخدم فعلًا.",
